...
//+kubebuilder:rbac:groups=seichiclick.seichi.click,resources=seichireviewgateways,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=seichiclick.seichi.click,resources=seichireviewgateways/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=seichiclick.seichi.click,resources=seichireviewgateways/finalizers,verbs=update
